...
hist(choco$Rating)
```
Ratings are approximately normal with a couple of outliers at 5.
2. Do ratings depend on the cacao percentage of a chocolate bar? 
```{r}
cor(choco$Rating,choco$Cocoa.Pct)
```
There is a somewhat weak and negative relationship between cacao percentage and ratings. 
