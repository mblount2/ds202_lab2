...
The plots are small and could be enlarged so that the information is easier to read. The key in the bottom left corner may be obsructing some data points and should be moved.
